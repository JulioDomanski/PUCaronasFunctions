...
$ResourceGroupName = 'PUCaronas123'
$StorageAccountName = 'funcstoragepucaronas'
$FunctionAppName = 'CRUDusuariosPUC'
$Location = 'eastus2' 
...
=======
# Resource Names and Location
ResourceGroupName='PUCaronas1'
StorageAccountName='funcstoragepucaronas1'
FunctionAppName='CRUDusuariosPUC1'
Location='eastus2'
...
# Create function app
az functionapp create --resource-group "$ResourceGroupName" --consumption-plan-location "$Location" --runtime python --runtime-version 3.10 --functions-version 4 --name "$FunctionAppName" --os-type linux --storage-account "$StorageAccountName"
>>>>>>> d279344 (adicionado funcao VERusuario)
